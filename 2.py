...
access = "Ue7GxxL39kExXrpKtyA2rx5zI95Ifxf0qfBQrx79"
secret = "exxPtrQDiM0a4K7fD1x3gTxlxu9cgCVV9uxa2Ekx"
myToken = "xoxb-2034925797488-1998163060551-7BVe7QuXeQPv29gT9lC7416F"
...
while True:
    try:
        ...
        if start_time < now < end_time - datetime.timedelta(seconds=10):
            target_price = get_target_price("KRW-XRP", 0.0015)
